...
const experiencesData = [
  {
    ...
    period: "May 2023 – Now",
    summary:
      "Contributed to knowledge graph development, contract data retrieval and analysis, and prompt engineering. Managed projects using Agile, Scrum, and Kanban.",
  },
  {
    ...
    summary:
      "Streamlined occupancy reporting with auto-updated visualizations and analyzed flight records for customer insights.",
  },
  {
    ...
    summary:
      "Developed a revenue prediction model and automatized data processes, leading to significant workflow improvements.",
  },
  {
